...
func SeedUsers(db *gorm.DB) error {
	users := []models.User{
		...
		{Username: "user4", LastName: "Elo", FirstName: "Test", Email: "test@test.fr", Password: "$2a$12$h8goAAbVN8NpvEr37BxEbuuxCyZCrojpj89UoK4FekkS3ITQnnqn6", Roles: config.RoleUser},
